...
#include <delaunay/MeshConvexPerimeter.h>
...
class MeshConvexPerimeterTest : public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE(MeshConvexPerimeterTest);
    CPPUNIT_TEST(testMeshHasConvexPerimeterConvex);
    CPPUNIT_TEST(testMeshHasConvexPerimeterConcave);
...
public:
    ...
    void testMeshHasConvexPerimeterConvex() {
        // Perimeter is convex.
        mV1->setPosition(Vector2f(0, 10));
        mV2->setPosition(Vector2f(10, 0));
        mV3->setPosition(Vector2f(10, 10));
        ...
        CPPUNIT_ASSERT(MeshHasConvexPerimeter(mMeshPtr));
    }

    void testMeshHasConvexPerimeterConcave() {
        // Perimeter is concave.
        mV1->setPosition(Vector2f(0, 10));
        mV2->setPosition(Vector2f(3, 7));
        mV3->setPosition(Vector2f(10, 10));
        mV4->setPosition(Vector2f(0, 0));
...
CPPUNIT_TEST_SUITE_REGISTRATION(MeshConvexPerimeterTest);
